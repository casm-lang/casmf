...
ifeq ($(ENV_CC),emcc)
	...
	@$(MAKE) --no-print-directory run-test ENV_FLAGS="$(ENV_FLAGS)" ENV_ARGS="$(ENV_ARGS)"

run-test:
	@echo "-- Running unit test"
	@$(ENV_ARGS) ./$(OBJ)/$(TARGET)-check --gtest_output=xml:obj/report.xml $(ENV_ARGS)
...
run-benchmark:
	...
	@$(ENV_ARGS) ./$(OBJ)/$(TARGET)-run -o console -o json:obj/report.json $(ENV_ARGS)
